...
public class ChangePassWord extends HttpServlet
{
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		// 数据合法性判断
		if (null == accode || "".equals(accode) || null == password || "".equals(password) ||password.length()>32) 
		{
		...
		//AccountDataCenter.getInstance().modifyPwdKeyTable(accode, password);;
		AccountDataCenter.getInstance().modifyPwdAccout(accode, password);
