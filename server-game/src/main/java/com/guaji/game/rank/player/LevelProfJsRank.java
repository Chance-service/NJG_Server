...
@SingleRank(type = RankType.LEVEL_PROFJS_RANK, maxRankNum = GsConst.MAX_RANK_NUM)
public class LevelProfJsRank extends PlayerRank {

	private String sql = "from PlayerEntity where level > 0 and invalid = 0 and prof=1 order by level desc";

	
	@Override
	public void loadRank() {
		this.setRankType(RankType.LEVEL_PROFJS_RANK);
		super.loadRank();
