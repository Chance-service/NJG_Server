...
@SingleRank(type = RankType.WING_BLUE_TIME_RANK, maxRankNum = GsConst.MAX_WING_RANK_NUM)
public class WingBlueRank extends WingRank {
	private String sql = "from PlayerWingsEntity where blueTime > 0 and invalid = 0 order by blueTime asc";
	...
	public void setRankParam(PlayerWingsEntity playerWingsEntity, PlayerWingRank wingRank) {
		...
		wingRank.setUseTime(playerWingsEntity.getBlueTime());
	}
}
