...
@SingleRank(type = RankType.LEVEL_ALL_RANK, maxRankNum = GsConst.MAX_RANK_NUM)
public class LevelAllRank extends PlayerRank {

	private String sql = "from PlayerEntity where level > 0 and invalid = 0 order by level desc";

	@Override
	public void loadRank() {
		this.setRankType(RankType.LEVEL_ALL_RANK);
		super.loadRank();
	}
