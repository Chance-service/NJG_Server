...
import com.guaji.game.rank.customspass.PassInfoRank;
import com.guaji.game.util.GsConst;

@SingleRank(type = RankType.ALLIANCE_LEVEL_RANK, maxRankNum = GsConst.MAX_RANK_NUM)
public class AllianceLevelRank extends AllianceRank {

	private String sql = "from AllianceEntity where level > 0 and invalid = 0 order by level desc";

	@Override
	public void loadRank() {
		this.setRankType(RankType.ALLIANCE_LEVEL_RANK);
		super.loadRank();
