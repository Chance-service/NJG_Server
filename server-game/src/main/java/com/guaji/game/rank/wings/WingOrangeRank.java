...
@SingleRank(type = RankType.WING_ORANGE_TIME_RANK, maxRankNum = GsConst.MAX_WING_RANK_NUM)
public class WingOrangeRank extends WingRank {
	private String sql = "from PlayerWingsEntity where orangeTime > 0 and invalid = 0 order by orangeTime asc";
	...
	public void setRankParam(PlayerWingsEntity playerWingsEntity, PlayerWingRank wingRank) {
		...
		wingRank.setUseTime(playerWingsEntity.getOrangeTime());
	}
}
