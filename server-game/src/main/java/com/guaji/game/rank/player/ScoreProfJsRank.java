...
@SingleRank(type = RankType.SCORE_PROFJS_RANK, maxRankNum = GsConst.MAX_RANK_NUM)
public class ScoreProfJsRank extends PlayerRank{


	private String sql = "from PlayerEntity where fightvalue > 0 and invalid = 0 and prof=1 order by fightvalue desc";
	
	@Override
	public void loadRank() {
		this.setRankType(RankType.SCORE_PROFJS_RANK);
		super.loadRank();
