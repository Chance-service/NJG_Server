...
public class Activity183BuyHandler implements IProtocolHandler {
    ...
    public boolean onProtocol(AppObj appObj, Protocol protocol) {
        ...
        ActivityGiftAward183Cfg cfg = ConfigManager.getInstance().getConfigByKey(ActivityGiftAward183Cfg.class,req.getCfgId());
