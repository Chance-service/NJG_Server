...
public class Activity184BuyHandler implements IProtocolHandler {
    ...
    public boolean onProtocol(AppObj appObj, Protocol protocol) {
        ...
        ActivityGiftAward184Cfg cfg = ConfigManager.getInstance().getConfigByKey(ActivityGiftAward184Cfg.class,req.getCfgId());
