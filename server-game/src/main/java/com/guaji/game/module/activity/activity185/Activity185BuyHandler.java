...
public class Activity185BuyHandler implements IProtocolHandler {
    ...
    public boolean onProtocol(AppObj appObj, Protocol protocol) {
        ...
        ActivityGiftAward185Cfg cfg = ConfigManager.getInstance().getConfigByKey(ActivityGiftAward185Cfg.class,req.getCfgId());
