...
public class ContinueRechargeStatus {
	// 活动期间累计充值钻石数
	...
	{
		Map<Object, ContinueRechargeCfg> cfgList = ConfigManager.getInstance().getConfigMap(ContinueRechargeCfg.class);

		for(ContinueRechargeCfg cfg:cfgList.values())
		{
