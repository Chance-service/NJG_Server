...
public class Activity182BuyHandler implements IProtocolHandler {
    ...
    public boolean onProtocol(AppObj appObj, Protocol protocol) {
        ...
        ActivityGiftAward182Cfg cfg = ConfigManager.getInstance().getConfigByKey(ActivityGiftAward182Cfg.class,req.getCfgId());
