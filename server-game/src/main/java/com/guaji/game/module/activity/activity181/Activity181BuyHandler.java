package com.guaji.game.module.activity.activity181;
...
public class Activity181BuyHandler implements IProtocolHandler {
    ...
    public boolean onProtocol(AppObj appObj, Protocol protocol) {
        ...
        ActivityGiftAward181Cfg cfg = ConfigManager.getInstance().getConfigByKey(ActivityGiftAward181Cfg.class,req.getCfgId());
		...
		Activity181Status status = ActivityUtil.getActivityStatus(player.getPlayerData(), activityId, activityTimeCfg.getStageId(), Activity181Status.class);
