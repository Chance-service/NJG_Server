 ...
 *
 */
public class AllianceShopRefreshHandler implements IProtocolHandler {
	...
	public boolean onProtocol(AppObj appObj, Protocol protocol) {
		...
		// 获取商品列表;
//		HPAllianceShopS.Builder shopBuilder = AllianceManager.getInstance().refreshShopItemList(protocol.getType(), player, playerAllianceEntity, allianceEntity, false);
