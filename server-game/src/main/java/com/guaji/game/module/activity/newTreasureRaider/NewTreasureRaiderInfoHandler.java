...
public class NewTreasureRaiderInfoHandler implements IProtocolHandler {
	...
	public boolean onProtocol(AppObj appObj, Protocol protocol) {
		...
		player.sendProtocol(Protocol.valueOf(HP.code.NEW_TREASURE_RAIDER_INFO_S, builder));
		return true;
	}
	...
	public static HPNewTreasureRaiderInfoSync.Builder generateInfo(Player player)
	{
		...
		NewTreasureRaiderStatus status = ActivityUtil.getActivityStatus(player.getPlayerData(), activityId,
				activityTimeCfg.getStageId(), NewTreasureRaiderStatus.class);
		// 总次数
		...
		int genLeftTimes = NewTreasureRaiderDropCfg.getLimitTimes(totalTimes);
