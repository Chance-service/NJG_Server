...
@ConfigManager.XmlResource(file = "xml/newTreasureRaiderBuff.xml", struct = "map")
public class NewTreasureRaiderMultipBuffCfg extends ConfigBase {
	/**
	 * 掉落物组ID
	 */
	@Id
	...
	public NewTreasureRaiderMultipBuffCfg() {
		id = 0;
		multiple = 1;
		overtime = 0;
		rate = 0;
