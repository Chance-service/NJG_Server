 ...
 */
@ConfigManager.XmlResource(file = "xml/releaseURBuff123.xml", struct = "map")
public class ReleaseURMultipBuffCfg123 extends ConfigBase {
	/**
	 * 掉落物组ID
	 */
	@Id
	...
	public ReleaseURMultipBuffCfg123() {
		id = 0;
		multiple = 1;
		overtime = 0;
		rate = 0;
