...
@ConfigManager.XmlResource(file = "xml/godSeaShop_2.xml", struct = "list")
public class CycleStageShopCfg extends ConfigBase {
	 ...
	 * @return
	 */
	public static DailyShopItem getDailyShopInfo(CycleStageShopCfg cfg, int id) {
	 ...
	 * 取得所有商品
	 */
	public static List<CycleStageShopCfg> getShopCfgs(){
		List<CycleStageShopCfg> aList = ConfigManager.getInstance().getConfigList(CycleStageShopCfg.class);
		return aList ;
	}
}
