...
@ConfigManager.XmlResource(file = "xml/worldBossAwards.xml", struct = "list")
public class WorldBossAwardsCfg extends ConfigBase {
	...
	public static String getPlayerRankAwards(int awardsId, int rank) {
		...
		for(WorldBossAwardsCfg awardsCfg : ConfigManager.getInstance().getConfigList(WorldBossAwardsCfg.class)) {
