...
@ConfigManager.XmlResource(file = "xml/crossShop.xml", struct = "list")
public class CrossShopCfg extends ConfigBase {
	 ...
	 * @return
	 */
	public static DailyShopItem getShopInfo(CrossShopCfg cfg, int id) {
	 ...
	 * 取得所有商品
	 */
	public static List<CrossShopCfg> getShopCfgs(){
		List<CrossShopCfg> aList = ConfigManager.getInstance().getConfigList(CrossShopCfg.class);
		return aList ;
	}
}
