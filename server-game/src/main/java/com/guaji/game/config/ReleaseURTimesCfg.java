 ...
 *
 */
@ConfigManager.XmlResource(file = "xml/releaseURTimes.xml", struct = "map")
public class ReleaseURTimesCfg extends ConfigBase {
	/**
	 * vip等级
	 */
	@Id
	...
	public static ReleaseURTimesCfg getTimesCfgByVipLevel(int vipLevel) {
		return ConfigManager.getInstance().getConfigByKey(ReleaseURTimesCfg.class, vipLevel);
	}
