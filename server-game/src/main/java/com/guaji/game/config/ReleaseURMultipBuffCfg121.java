 ...
 */
@ConfigManager.XmlResource(file = "xml/releaseURBuff121.xml", struct = "map")
public class ReleaseURMultipBuffCfg121 extends ConfigBase {
	/**
	 * 掉落物组ID
	 */
	@Id
	...
	public ReleaseURMultipBuffCfg121() {
		id = 0;
		multiple = 1;
		overtime = 0;
		rate = 0;
