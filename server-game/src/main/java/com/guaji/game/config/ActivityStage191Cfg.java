...
@ConfigManager.XmlResource(file = "xml/activityStage191.xml", struct = "map")
public class ActivityStage191Cfg extends ConfigBase {
	...
	private static Map<Integer,List<ActivityStage191Cfg>> typeMapCfg;
	
	private static Set<Integer> allType;
	
	private static  Map<Integer,Integer> typeMaxStar;

	public ActivityStage191Cfg() {
		this.id = 0;
		this.nextid = 0;
		this.monsterIds = "";
		this.dropItems = "";
