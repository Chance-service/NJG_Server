...
@ConfigManager.XmlResource(file = "xml/guildShop.xml", struct = "list")
public class GuildShopCfg extends ConfigBase {
	 ...
	 * @return
	 */
	public static DailyShopItem getShopInfo(GuildShopCfg cfg, int id) {
	 ...
	 * 取得所有商品
	 */
	public static List<GuildShopCfg> getShopCfgs(){
		List<GuildShopCfg> aList = ConfigManager.getInstance().getConfigList(GuildShopCfg.class);
		return aList ;
	}
