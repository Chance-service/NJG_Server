...
@ConfigManager.XmlResource(file = "xml/newTreasureRaiderBuff120.xml", struct = "map")
public class NewTreasureRaiderMultipBuffCfg3 extends ConfigBase {
	/**
	 * 掉落物组ID
	 */
	@Id
	...
	public NewTreasureRaiderMultipBuffCfg3() {
		id = 0;
		multiple = 1;
		overtime = 0;
		rate = 0;
