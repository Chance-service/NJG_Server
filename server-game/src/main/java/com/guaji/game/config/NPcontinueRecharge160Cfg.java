 ...
 */
@ConfigManager.XmlResource(file = "xml/NPcontinueRechargeMoney160.xml", struct = "map")
public class NPcontinueRecharge160Cfg extends ConfigBase {
	...
	public NPcontinueRecharge160Cfg() {
		this.id = 0;
		this.nTotalMoney = 0;
		this.awards = "";
	}
