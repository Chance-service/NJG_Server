 ...
 *
 */
@ConfigManager.XmlResource(file = "xml/releaseURTimes121.xml", struct = "map")
public class ReleaseURTimesCfg121 extends ConfigBase {
	/**
	 * vip等级
	 */
	@Id
	...
	public static ReleaseURTimesCfg121 getTimesCfgByVipLevel(int vipLevel) {
		return ConfigManager.getInstance().getConfigByKey(ReleaseURTimesCfg121.class, vipLevel);
	}
