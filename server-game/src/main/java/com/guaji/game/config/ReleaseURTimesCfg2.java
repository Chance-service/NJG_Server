 ...
 *
 */
@ConfigManager.XmlResource(file = "xml/releaseURTimes2.xml", struct = "map")
public class ReleaseURTimesCfg2 extends ConfigBase {
	/**
	 * vip等级
	 */
	@Id
	...
	public static ReleaseURTimesCfg2 getTimesCfgByVipLevel(int vipLevel) {
		return ConfigManager.getInstance().getConfigByKey(ReleaseURTimesCfg2.class, vipLevel);
	}
