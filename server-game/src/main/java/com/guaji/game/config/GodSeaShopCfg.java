...
@ConfigManager.XmlResource(file = "xml/godSeaShop.xml", struct = "list")
public class GodSeaShopCfg extends ConfigBase {
	 ...
	 * @return
	 */
	public static DailyShopItem getDailyShopInfo(GodSeaShopCfg cfg, int id) {
	 ...
	 * 取得所有商品
	 */
	public static List<GodSeaShopCfg> getShopCfgs(){
		List<GodSeaShopCfg> aList = ConfigManager.getInstance().getConfigList(GodSeaShopCfg.class);
		return aList ;
	}
}
