 ...
 *
 */
@ConfigManager.XmlResource(file = "xml/releaseURTimes128.xml", struct = "map")
public class ReleaseURTimesCfg128 extends ConfigBase {
	/**
	 * vip等级
	 */
	@Id
	...
	public static ReleaseURTimesCfg128 getTimesCfgByVipLevel(int vipLevel) {
		return ConfigManager.getInstance().getConfigByKey(ReleaseURTimesCfg128.class, vipLevel);
	}
