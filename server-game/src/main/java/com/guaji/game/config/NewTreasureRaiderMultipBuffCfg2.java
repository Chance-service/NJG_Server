...
@ConfigManager.XmlResource(file = "xml/newTreasureRaiderBuff2.xml", struct = "map")
public class NewTreasureRaiderMultipBuffCfg2 extends ConfigBase {
	/**
	 * 掉落物组ID
	 */
	@Id
	...
	public NewTreasureRaiderMultipBuffCfg2() {
		id = 0;
		multiple = 1;
		overtime = 0;
		rate = 0;
