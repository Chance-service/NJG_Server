...
@Entity
@Table(name = "singleboss_reward")
public class SingleBossRewardEntity extends DBEntity {
	...
	public SingleBossRewardEntity() {

		this.createTime = GuaJiTime.getCalendar().getTime();
	}

	public static SingleBossRewardEntity valueOf(int stageId) {

		SingleBossRewardEntity entity = new SingleBossRewardEntity();
