...
@Entity
@Table(name = "godsea_shop")
public class GodSeaShopEntity extends DBEntity {
	@Id
	...
	public static GodSeaShopEntity valueOf(Player player) {
		GodSeaShopEntity godseaShopEntity = new GodSeaShopEntity();
		godseaShopEntity.playerId = player.getId();
		GodSeaMarket.getInstance().shopItemInfo(player, godseaShopEntity,true);
