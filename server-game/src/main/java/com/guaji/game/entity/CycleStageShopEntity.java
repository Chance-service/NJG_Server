...
@Entity
@Table(name = "cyclestage_shop")
public class CycleStageShopEntity extends DBEntity {
	@Id
	...
	public static CycleStageShopEntity valueOf(Player player) {
		CycleStageShopEntity cyclestageShopEntity = new CycleStageShopEntity();
		cyclestageShopEntity.playerId = player.getId();
		CycleStageMarket.getInstance().shopItemInfo(player, cyclestageShopEntity,true);
