...
@Entity
@Table(name = "arena_shop")
public class ArenaShopEntity extends DBEntity {
	@Id
	...
	public static ArenaShopEntity valueOf(Player player) {
		ArenaShopEntity arenaShopEntity = new ArenaShopEntity();
		arenaShopEntity.playerId = player.getId();
		ArenaMarket.getInstance().shopItemInfo(player, arenaShopEntity,true);
