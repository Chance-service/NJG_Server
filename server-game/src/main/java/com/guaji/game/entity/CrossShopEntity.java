...
@Entity
@Table(name = "cross_shop")
public class CrossShopEntity extends DBEntity {
	@Id
	...
	public static CrossShopEntity valueOf(Player player) {
		CrossShopEntity crossShopEntity = new CrossShopEntity();
		crossShopEntity.playerId = player.getId();
		CrossMarket.getInstance().shopItemInfo(player, crossShopEntity,true);
