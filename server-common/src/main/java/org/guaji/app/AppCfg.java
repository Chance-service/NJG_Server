 ...
 * 应用配置类
 */
public class AppCfg extends ConfigBase {
	/**
	 * 管理员
	 */
	 ...
	 * 後臺驗證功能
	 */
	protected final boolean platformVerify;
	/**
	 * 消息任务模式
	 */
	 ...
	 * tick线程数
	 */
	protected final int tickThreads;
	/**
	 * 逻辑线程数
	 */
	...
	public AppCfg() {
		...
		msgTaskMode = true;
		tickPeriod = 50;
		threadNum = cpuNums*16;
		taskThreads = cpuNums*2;
		tickThreads = cpuNums*16;
		dbThreads = 0;
		calendarOffset = 0;
		hostIp = "";
		acceptorPort = 0;
	...
	/**
	 * @return the tickThreads
	 */
	public int getTickThreads() {
		return tickThreads;
	}
